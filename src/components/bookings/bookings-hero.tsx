  ...
  return (
    <section className="relative overflow-hidden bg-[#0a0a0c] border-b border-stone-50/10">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
        ...
        {/* Large decorative "47" watermark */}
        <div className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 select-none font-display text-[20vw] leading-none tracking-tighter text-stone-50/[0.03] sm:right-8 lg:right-16 lg:text-[14vw]">
          47
        </div>
      </div>
    </section>
